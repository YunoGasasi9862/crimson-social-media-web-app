...
$friendsUsers = User::get_users_by_username($usernames);
          ...
          <div class="submain" id="submain">
            <ul>
              ...
              <li><img src="../img/avatar-1.webp" id="pic1" alt="">
                <div class="square"><a href="#">Subsddddddddddddddddddddddddddd dddddddddd
                    dddddddddddmenu wtrtÖğesi
                    iiii </a></div>
                <p></p>
                <h1></h1>
              </li>
            ...
            <ul>
              ...
              <?php
                            foreach ($friends as $friend) {
                                echo '
                                    <li>
                                        <img src="../img/avatar-1.webp" id="frpic1" alt="" />
                                        <div class="frsquare">
